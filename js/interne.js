document.addEventListener("DOMContentLoaded", () => {
    ...
    // ================================
    // TOGGLE LOGIN / DEMANDE
    // ================================
    if (btnShowDemande && sectionDemande) {
        btnShowDemande.addEventListener("click", (e) => {
            e.preventDefault();

            if (sectionConnexion) sectionConnexion.classList.add("d-none");
    ...
    if (btnBack && sectionDemande) {
        btnBack.addEventListener("click", (e) => {
            e.preventDefault();

            sectionDemande.classList.add("d-none");
            if (sectionConnexion) sectionConnexion.classList.remove("d-none");
        });
    }

    // ================================
    // FORMULAIRE DEMANDE + CAPTCHA
    // ================================
    ...
    if (refreshBtn) refreshBtn.addEventListener("click", displayCaptcha);
