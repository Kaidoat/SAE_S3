  ...
  <div class="header-top-wrapper">
    <div class="ribbon-bar">
      <div class="cta-bubbles-container d-none d-md-flex gap-3 me-5">
        ...
        <a href="#" class="cta-bubble bubble--l rounded-circle"><span>JE FAIS<br>UN DON</span></a>
      </div>
    </div>
    ...
    [
      ...
      <div class="collapse navbar-collapse justify-content-center" id="main-navbar">
        <ul class="navbar-nav text-uppercase fw-semibold text-center">
          <li class="nav-item"><a class="nav-link" href="/"><i class="bi bi-house-door-fill"></i></a></li>
          <li class="nav-item"><a class="nav-link active" href="#">Qui sommes nous ?</a></li>
          <li class="nav-item"><a class="nav-link" href="#">Nous soutenir</a></li>
          <li class="nav-item"><a class="nav-link" href="#">Faire appel à nous</a></li>
